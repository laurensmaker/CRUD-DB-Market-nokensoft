...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Kabupaten</h1>
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">                                    
                    <div class="col-lg">
                        <div class="p-5">                                            
                            <form class="user" action="{{ url('kabupaten/update', $kabupaten->id) }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="Kabupaten" name="nama" value="{{ $kabupaten->nama }}">
                                            @if($errors->has('nama'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="provinsi" name="kode_pos" value="{{ $kabupaten->kode_pos }}">
